...
Wolfssl_C_Files := $(PROJECT_ROOT)/ra/wolfssl-ra-attester.c \
	$(PROJECT_ROOT)/ra/wolfssl-ra-challenger.c \
  $(PROJECT_ROOT)/ra/sgxsdk-ra-attester_t.c \
  $(PROJECT_ROOT)/ra/ra-challenger.c \
	$(PROJECT_ROOT)/ra/wolfssl-ra.c \
	$(PROJECT_ROOT)/ra/ra_tls_t.c \
  $(PROJECT_ROOT)/option/ra_tls_options.c

Wolfssl_Include_Paths := -I$(WOLFSSL_ROOT)/ \
						 -I$(WOLFSSL_ROOT)/wolfcrypt/ \
						 -I$(SGX_SDK)/include -I$(SGX_SDK)/include/tlibc -I$(SGX_SDK)/include/stlport -I${PROJECT_ROOT}
